    ...
    <div style={{ maxWidth: 720 }}>
      ...
      <div style={S.section}>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'flex-end', flexWrap: 'wrap' }}>
          ...
          <div style={{ ...S.fieldBox, flexShrink: 0 }}>
            <button style={{ ...S.btn('#59c2ed', busy), minWidth: 96, justifyContent: 'center' }} onClick={handleExecute} disabled={busy}>
      ...
      <div style={S.section}>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'flex-end', flexWrap: 'wrap' }}>
          ...
          <div style={{ ...S.fieldBox, flexShrink: 0 }}>
            <button style={{ ...S.btn('#59c2ed', saving), minWidth: 96, justifyContent: 'center' }} onClick={handleSaveSchedule} disabled={saving}>
